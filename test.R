...
system.time(res1 <- OSRMroute(data[rep(1:20, 100), ], data[rep(1:10, 1), ], 
                             "/home/benoitt/osrm/osrm-data/nord-pas-de-calais-latest.osrm", nthreads = 1))

system.time(res2 <- OSRMroute(data[rep(1:20, 100), ], data[rep(1:10, 1), ], 
                              "/home/benoitt/osrm/osrm-data/nord-pas-de-calais-latest.osrm", nthreads = 4))

system.time(res3 <- OSRMroute(data[rep(1:20, 100), ], data[rep(1:10, 1), ], 
                              "/home/benoitt/osrm/osrm-data/nord-pas-de-calais-latest.osrm", nthreads = 8))
